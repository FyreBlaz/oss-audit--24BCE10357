...
```bash
PrathamJain@ubuntu-server:~/Vlc$ ./01-identify.sh
================================================================================
                   Vlc AUDIT - SYSTEM IDENTITY                    
================================================================================
Linux Distribution: Ubuntu 22.04.3 LTS
Kernel Version:     5.15.0-89-generic
Current User:       PrathamJain
Home Directory:     /home/PrathamJain
...
```bash
PrathamJain@ubuntu-server:~/Vlc$ ./02-packages.sh
================================================================================
...
```bash
PrathamJain@ubuntu-server:~/Vlc$ ./03-auditor.sh
================================================================================
...
```bash
PrathamJain@ubuntu-server:~/Vlc$ ./04-logs.sh /var/log/syslog error
================================================================================
...
My name is PrathamJain, and I believe in the power of open-source software. My favorite project is Vlc, which has inspired me to contribute to the community. I support open-source software because because it promotes user freedom and collaboration.
Your manifesto has been saved to PrathamJain.txt.
================================================================================
```